const Footer = {
  render() {
    return `
        ...
        <img src="https://genk.mediacdn.vn/2018/10/19/photo-1-15399177932921872972438.png" class="mr-4 h-8" alt="Flowbite Logo">
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white"> Coppyright Truong</span>
        </a>
